                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {soilData.isBeginner && (
                      <motion.div 
                        ...
                        className="p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 shadow-inner space-y-4"
                      >
                        <label className="block">
                          ...
                          <div className="flex gap-2">
                            <div className="relative flex-1">
                              <input 
                                ...
                                placeholder="e.g. 2.5"
                              />
                              <span className="absolute right-5 top-1/2 -translate-y-1/2 text-xs font-bold text-emerald-500/50 mono">
                                {soilData.landUnit === 'Hectares' ? 'ha' : 'ac'}
                              </span>
                            </div>
                            <select 
                              value={soilData.landUnit}
                              onChange={(e) => setSoilData({...soilData, landUnit: e.target.value})}
                              className="bg-earth-400 border border-transparent rounded-xl text-xs font-bold text-white px-3 focus:border-emerald-500/30 transition-all outline-none"
                            >
